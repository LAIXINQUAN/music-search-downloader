...
public partial class MainViewModel : ObservableObject, IDisposable
{
    ...
    public IAsyncRelayCommand BackwardCommand { get; }
    ...
    public MainViewModel()
    {
        ...
        BackwardCommand = new AsyncRelayCommand(() => _media.SeekByAsync(TimeSpan.FromSeconds(-15)));
        ForwardCommand = new AsyncRelayCommand(() => _media.SeekByAsync(TimeSpan.FromSeconds(15)));
    ...
    private static string GetFriendlySource(string source)
    {
        ...
        if (normalized.Contains("qb音乐") || normalized.Contains("qbmusic") ||
            normalized.Contains("com.laixingquan") || normalized.Contains("laixinquan"))
        {
            return "QB音乐";
        }

...
public sealed class MediaTimelineTests
{
    ...
    [Theory]
    [InlineData("QB音乐", "QB音乐")]
    [InlineData("QBMusic.exe", "QB音乐")]
    [InlineData("com.laixingquan.musicdownloader", "QB音乐")]
    [InlineData("musicdownloader", "QB音乐")]
    [InlineData("chrome.exe", null)]
    public void KnownPlayerProcessMapping_OnlyRecognizesQbMusic(
        string sourceAppId,
        string? expected)
    {
    ...
    [Theory]
    [InlineData("QB音乐", true)]
    [InlineData("QBMusic.exe", true)]
    [InlineData("com.laixingquan.musicdownloader", true)]

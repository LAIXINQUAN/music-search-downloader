...
const I18N = {
  zh: {
    ...
    heroSub: '一个免费、开源的 Windows 音乐下载软件，聚合酷我、QQ音乐、网易云等多个平台，搜歌、在线播放、无损下载全搞定。',
  ...
  en: {
    ...
    heroSub: 'A free and open-source Windows music download app that aggregates Kuwo, QQ Music, NetEase Cloud and more. Search, stream and download lossless in one place.',
